  ...
  return (
    <section className=' border-2 p-10 m-2 sm:m-10 sm:p-10  lg:p-10 lg:m-20 xl:p-10 xl:m-20'>
                ...
                <div className='flex justify-center mb-10'>
                    <h5 class=" mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">{resto.name}</h5>
                </div>
                <div className='grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4'>
                    <div className='col1'>
                        <img class=" h-full  object-cover  rounded-t-lg " src={resto.photo.images.large.url} alt="" />
                    </div>
                    <div className='col2 ml-5'>
                        ...
                        <ol class="relative text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400">                  
                            ...
                            <li class="mb-10 ml-6">            
                                ...
                                <h3 class="font-medium leading-tight">{resto.open_now_text}</h3>
                            ...
                            <li class="mb-10 ml-6">
                                ...
                                <p class="text-sm">{resto.description}</p>
                            </li>
                            <li class="mb-10 ml-6">
                                <span class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                                ...
                                <p class="text-sm">{resto.address}</p>
                            </li>
                            <li class="mb-10 ml-6">
                            <span class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                            ...
                            <li class=" ml-6">
                                ...
                                <p class="text-sm"><a href='{resto.website}' target='_blank' >{resto.website}</a></p>
                            </li>
