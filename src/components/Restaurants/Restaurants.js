                ...
                <div className='flex justify-center'>
                    <div className=" grid  sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
                        ...
                        { currentRestos.map((resto , index)=>{
                            ...
                            return(
                                <a href={"/Restaurants/Details/"+index} className="hover:scale-110">
                                    <div className="m-5 max-w-sm rounded overflow-hidden shadow-lg">
                                        ...
                                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{resto.timezone }</span>
                                        ...
                                        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{resto.price==undefined ? '$10 - $30' : resto.price}</span>
                                        </div>
                                    </div>
                                </a>
                            )
